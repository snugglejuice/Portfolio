...
(function(w) {
  ...
  function init(){
    ...
    initVector();
    document.getElementById('points').onchange = function(){initVector();}
    document.getElementById('speed').onchange = function(){initVector();}
    document.getElementById('pattern1').onclick = function(){updatePattern(1);
                                                            initVector();}
    document.getElementById('pattern2').onclick = function(){updatePattern(2);
                                                            initVector();}
    document.getElementById('pattern3').onclick = function(){updatePattern(3);
                                                            initVector();}
  ...
  function initVector()
  {
    var nbPoint = document.getElementById('points').value;
